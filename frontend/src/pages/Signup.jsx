      ...
      >
        <div className="glass-effect rounded-2xl p-8 shadow-2xl">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold gradient-text mb-2">Join ConcertHub</h2>
            <p className="text-gray-400">Create your account to book amazing events</p>
          </div>
...
<<<<<<< HEAD
            ...
            <div className="flex justify-center">
              <GoogleLogin
                ...
                onError={() => {
                  // no-op; component shows its own error UI briefly
                }}
                useOneTap
              />
            </div>
